...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'business' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_BUSINESS_URL'),
            'host' => env('DB_BUSINESS_HOST', '127.0.0.1'),
            'port' => env('DB_BUSINESS_PORT', '3306'),
            'database' => env('DB_BUSINESS_DATABASE', 'forge'),
            'username' => env('DB_BUSINESS_USERNAME', 'forge'),
            'password' => env('DB_BUSINESS_PASSWORD', ''),
            'unix_socket' => env('DB_BUSINESS_SOCKET', ''),
            'charset' => 'utf8mb4',
